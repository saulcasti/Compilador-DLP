...
expresion:	'(' expresion ')'						{ $$ = $2; }
	...
	|	expresion	'AND'	expresion				{ $$ = new ExpresionBooleana($1, "AND", $3); }
	|	expresion	'OR'	expresion				{ $$ = new ExpresionBooleana($1, "OR", $3); }
	|	expresion	'MAYORIGUAL'	expresion		{ $$ = new ExpresionBooleana($1, "MAYORIGUAL", $3); }
	|	expresion	'DISTINTO'	expresion			{ $$ = new ExpresionBooleana($1, "DISTINTO", $3); }
	|	expresion	'MENORIGUAL'	expresion		{ $$ = new ExpresionBooleana($1, "MENORIGUAL", $3); }
